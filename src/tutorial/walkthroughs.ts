...
export const walkthroughs: Walkthrough[] = [
  {
    ...
    steps: [
      { text: 'Press L four times (10% of the window each): past 10 s, into the drums', keys: ['Shift+KeyL', 'Shift+KeyL', 'Shift+KeyL', 'Shift+KeyL'] },
      ...
      { text: 'Press Opt+h three times: nudge the end earlier by one pixel each', keys: ['Opt+KeyH', 'Opt+KeyH', 'Opt+KeyH'] },
  ...
  },
  {
    ...
    steps: [
      { text: 'Press K until fully zoomed out, then L once: near 3 s', keys: ['Shift+KeyK', 'Shift+KeyK', 'Shift+KeyK', 'Shift+KeyL'] },
  ...
  },
  {
    ...
    steps: [
      ...
      { text: 'Press H: the coarse step pulls the start well before the other region', keys: ['Shift+KeyH'] },
...
export const keymap: Record<string, [string, string][]> = {
  ...
  'Playhead mode': [
    ...
    ['i or v', 'Insert Region: start here, end 20% of the window later, end active'],
    ['I or V', 'Insert Region: end here, start 20% earlier, start active'],
